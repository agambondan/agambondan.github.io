...
module.exports = {
	 ...
	 * Graduation box is simply a reference to an object that requires layout. eg. Scales, Legend, Title.
	...
	update: function(chart, width, height) {
		...
		// Sort boxes by weight. Graduation higher weight is further away from the chart area
...
module.exports = Element.extend({
	...
	fit: function() {
		...
		if (tickOpts.display && display) {
			...
			if (isHorizontal) {
				// Graduation horizontal axis is more constrained by the height.
				...
				// Graduation vertical axis is more constrained by the width. Labels are the
